      ...
      <SiteFrame className="py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-xs text-muted leading-relaxed">
              Directorio y comunidad del ecosistema tech de Sinaloa. Tecnología,
              IA, software y emprendimiento. Código abierto, hecho con cariño
              desde Sinaloa.
            </p>
          ...
          <div>
            <p className="text-xs font-mono uppercase text-muted mb-3 tracking-wider">
              Directorio
            </p>
        ...
        <div className="mt-8 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-2xs text-muted font-mono">
            &copy; {new Date().getFullYear()} {SITE_TITLE}. Hecho en Sinaloa.
          </p>
          <a
