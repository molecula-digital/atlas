      ...
      <section>
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-sm text-muted mb-8">
            Tu oferta será revisada antes de publicarse.
          </p>
          ...
          >
            <div>
              <label
                htmlFor="title"
                className="block text-xs font-mono text-muted mb-1"
              >
                Título *
              </label>
              <input
                ...
                name="title"
                required
                className="w-full px-3 py-2 bg-background border border-border rounded-md text-base sm:text-sm text-primary"
